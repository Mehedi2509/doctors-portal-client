...
const SignUp = () => {
    ...
    const { registration, isLoading, user, authError } = useAuth();
            ...
            <Grid container spacing={2} sx={{ alignItems: 'center' }}>
                <Grid item sx={{ mt: 8 }} xs={12} lg={6}>
                    ...
                    {!isLoading && <form style={{ marginTop: '10px' }} onSubmit={handleSignUpSubmit}>
                        ...
                        <TextField sx={{ width: '75%', m: 1 }} onChange={handleOnChange} id="standard-basic" label="Re-Type Password" variant="standard" name="re_password" type="password" />
